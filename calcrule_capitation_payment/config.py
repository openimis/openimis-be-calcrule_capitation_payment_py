CLASS_RULE_PARAM_VALIDATION = [
    {
        ...
        "parameters": [
            ...
            },
            {
                ...
                "label": {"en": "Share Contribution", "fr": "Share Contribution"},
                "rights": {
                    "read": "121001",
                    "write": "121002",
                    "update": "121003",
            ...
            },
            {
                ...
                "label": {"en": "Weight Population", "fr": "Weight Population"},
                "rights": {
                    "read": "121001",
                    "write": "121002",
                    "update": "121003",
            ...
            },
            {
                ...
                "label": {"en": "Weight Number Visits", "fr": "Weight Number Visits"},
                "rights": {
                    "read": "121001",
                    "write": "121002",
                    "update": "121003",
...
DESCRIPTION_CONTRIBUTION_VALUATION = (
    ...
    " the HF for the capitation financing"
)
...
INTEGER_PARAMETERS = [
    "share_contribution",
    "weight_population",
    "weight_number_families",
    "weight_insured_population",
    "weight_number_insured_families",
    "weight_number_visits",
